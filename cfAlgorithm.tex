...
We must take some care in considering the fixed point of $M_\infty$. In our computation of $\sqrt[4]{2}$, we obtained 
 ...
 At this point, rather than immediately ingesting $x_1=1$, we might see if we can get another term of $y$ from $M$. We have
 \begin{equation*}
\begin{array}{cc}
...
At this point we may validly generate $[2,\infty)$ as a bound on $y_1$.
